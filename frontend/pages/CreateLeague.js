...
const CreateLeague = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('/api/leagues', formData);
      toast.success('Liga byla úspěšně vytvořena');
      navigate(`/leagues/${res.data._id}`);
    } catch (err) {
      setError(err.response?.data?.msg || 'Chyba při vytváření ligy');
      setLoading(false);
    }
  };
  ...
  return (
    <div>
      <h1 className="mb-4">Vytvořit novou ligu</h1>
          ...
          <Form onSubmit={handleSubmit}>
            <Form.Group className="mb-3" controlId="name">
              ...
              <Form.Control
                ...
                placeholder="Zadejte unikátní název ligy"
                required
              />
              <Form.Text className="text-muted">
                Název musí být unikátní a bude sloužit pro identifikaci ligy.
              </Form.Text>
            </Form.Group>
            ...
            <Form.Group className="mb-3" controlId="password">
              ...
              />
              <Form.Text className="text-muted">
                Toto heslo budou potřebovat ostatní uživatelé pro připojení do vaší ligy.
              </Form.Text>
            </Form.Group>
            ...
            <Button
              ...
              disabled={loading}
            >
              {loading ? 'Vytváření...' : 'Vytvořit ligu'}
            </Button>
          </Form>
        </Card.Body>
      </Card>
